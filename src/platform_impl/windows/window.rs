...
use platform_impl::platform::event_loop::{self, EventsLoop, DESTROY_MSG_ID, INITIAL_DPI_MSG_ID};
...
pub struct Window {
    ...
    event_loop_proxy: event_loop::EventsLoopProxy,
}
...
impl Window {
    pub fn new(
        ...
        event_loop.execute_in_thread(move |inserter| {
    ...
    pub fn set_resizable(&self, resizable: bool) {
        ...
        self.event_loop_proxy.execute_in_thread(move |_| {
    ...
    pub fn set_cursor(&self, cursor: MouseCursor) {
        ...
        self.event_loop_proxy.execute_in_thread(move |_| unsafe {
...
unsafe fn register_window_class(
    ...
    let class = winuser::WNDCLASSEXW {
        ...
        lpfnWndProc: Some(event_loop::callback),
        cbClsExtra: 0,
        cbWndExtra: 0,
